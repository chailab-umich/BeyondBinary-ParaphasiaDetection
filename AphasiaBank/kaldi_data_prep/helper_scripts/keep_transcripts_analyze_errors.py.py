'''
Analyze trends in CHAT transcriptions:
    -error tendencies for subtypes
    -likelihood of making special form marking error w/pauses

ignore events like laughing or breathing
text should preserve word-level error codes
    Analyze errors in transcription [* ]

preserve special form markers (@si, @sas)
keep oovs
