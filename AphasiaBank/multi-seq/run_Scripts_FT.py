...
def change_yaml(yaml_src,yaml_target,data_fold_dir,frid_fold,output_neurons,output_dir,base_model,freeze_arch_bool, loss_asr_weight):
    # copy src to tgt
    ...
    with open(yaml_target) as fin:
        ...
        filedata = filedata.replace('loss_asr_weight_PLACEHOLDER', f"{loss_asr_weight}")
