...
class DynamicLossScaler:
    ...
    def update_avg_losses(self, loss1, loss2):
        self.avg_loss1 = self.alpha * self.avg_loss1 + (1 - self.alpha) * loss1.item()
        self.avg_loss2 = self.alpha * self.avg_loss2 + (1 - self.alpha) * loss2.item()
...
class ASR(sb.Brain):
    ...
    def compute_objectives(self, predictions, batch, stage):
        ...
        if hasattr(self, 'loss_scaler'):
            ...
            scaled_loss_asr, scaled_loss_para = self.loss_scaler.scale_losses(loss_asr, loss_para_seq)
