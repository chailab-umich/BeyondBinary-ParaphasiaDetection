...
def change_yaml(yaml_src,yaml_target,data_fold_dir,frid_fold,output_neurons,output_dir,base_model,freeze_arch_bool,prepend_gt):
    # copy src to tgt
    ...
    viz_utts = ['P5_P2_SW_C4-2','P10_B1_SV_C1-3','P12_6W_SW_C6-4','P8_T2_SW_C3-3','P2_T6_SW_C3-3','P2_B2_SE_C1-4'] # fold 1
...
if __name__ == "__main__":
    ...
    if TRAIN_FLAG:
        ...
        while i <=12:
            ...
            change_yaml(yaml_src,yaml_target,data_fold_dir,i,OUTPUT_NEURONS,EXP_DIR,BASE_MODEL,FREEZE_ARCH,PREPEND_GT)
            ...
            cmd = ['python', '-m', 'torch.distributed.launch',
                ...
                'train_Transcription_GT.py', f'{yaml_target}',
