...
def change_yaml(yaml_src,yaml_target,data_fold_dir,frid_fold,output_neurons,output_dir,base_model,freeze_arch_bool,dynamic_alpha):
    # copy src to tgt
    ...
    with open(yaml_target) as fin:
        ...
        filedata = filedata.replace('dynamic_alpha_PLACEHOLDER', f"{dynamic_alpha}")
...
if __name__ == "__main__":
    ...
    if TRAIN_FLAG:
        yaml_src = "/home/mkperez/speechbrain/AphasiaBank/hparams/dev/MTL_base.yml"
        yaml_target = "/home/mkperez/speechbrain/AphasiaBank/hparams/dev/MTL_fold.yml"
        start = time.time()
        ...
        while i <=4:
            ...
            change_yaml(yaml_src,yaml_target,data_fold_dir,i,OUTPUT_NEURONS,EXP_DIR,BASE_MODEL,FREEZE_ARCH,DYNAMIC_ALPHA)
            ...
            cmd = ['python', '-m', 'torch.distributed.launch',
                ...
                'train_MTL_scheduler.py', f'{yaml_target}']
