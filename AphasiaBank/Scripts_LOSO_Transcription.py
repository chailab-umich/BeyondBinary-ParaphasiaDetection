...
if __name__ == "__main__":
    ...
    if FREEZE_ARCH:
        ...
        # EXP_DIR = f"ISresults/full_FT_Transcription_Scripts/vis_dev_S2S-hubert-Transformer-500"
        # BASE_MODEL = f"ISresults/full_FT_Transcription_Proto/bpe_ES_S2S-hubert-Transformer-500"
        EXP_DIR = f"ISresults/full_FT_Transcription_Scripts/binary_S2S-hubert-Transformer-500"
        BASE_MODEL = f"ISresults/full_FT_Transcription_Proto/binary_S2S-hubert-Transformer-500"

    if TRAIN_FLAG:
        # yaml_src = "/home/mkperez/speechbrain/AphasiaBank/hparams/Scripts/transcription_test.yml" # CHANGE BACK!!
